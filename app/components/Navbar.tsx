...
<button
  ...
  type="button"
>
  <input placeholder="Search docs..." className="hidden bg-transparent outline-none lg:inline-flex"></input>
  <input placeholder="Search..." className="inline-flex lg:hidden   bg-transparent outline-none"></input>
  <kbd
